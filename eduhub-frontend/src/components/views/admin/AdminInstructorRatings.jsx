...
const AdminInstructorRatings = () => {
  ...
  useEffect(() => {
    if (courses.length > 0) {
      fetchRatingsData();
      const intervalId = setInterval(fetchRatingsData, 30000);
  ...
  // Calcula las estadísticas del curso seleccionado.
  ...
  // Calcula el promedio global de todas las reseñas.
      ...
      <div className="flex-grow-1">
        ...
        <div className="overflow-auto vh-100">
          <main className="px-3 px-md-5 pt-5 mt-5 ms-md-5">
            ...
            {/* PROMEDIO GENERAL Y DATOS DEL INSTRUCTOR (siempre visibles) */}
