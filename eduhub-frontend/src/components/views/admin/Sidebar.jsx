...
import { Home, User, DollarSign, FileText, LogOut, Users} from "react-feather";
    ...
    return (
        ...
        >
            <div className="d-flex flex-column h-100 w-100 pt-1">
                ...
                <button
                    className="btn btn-outline-secondary my-1 d-flex align-items-center col-12" onClick={ isExpanded ? (e) => { e.stopPropagation(); navigate("/profile"); } : null }>
