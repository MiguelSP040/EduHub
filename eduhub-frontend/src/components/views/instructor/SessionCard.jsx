  ...
  return (
    <div className="card rounded-4 my-3 p-0">
        <div className="card-header bg-none d-flex justify-content-between align-items-center">
            {isEditing ? (
                <input type="text" className="form-control w-100" value={editedSession.nameSession}
        ...
        <div className="card-body d-flex flex-wrap">
            <div className="img-container">
                <img src={session.multimedia} alt="multimedia" className="me-3 rounded-3 img-fluid d-none d-sm-block"
        ...
        <div className="card-footer text-end">
            <div>
                {isEditing ? (
                    <div>
                        <button className="btn btn-purple-900 btn-sm mx-2" onClick={handleUpdateSession}>
                            Guardar
                        </button>
                        <button className="btn btn-purple-400 btn-sm" onClick={() => setIsEditing(false)}>
                            Cancelar
                        </button>
                    </div>
                ) : (
                    <div>
                        <button className="btn btn-purple-900 btn-sm me-2" onClick={() => setIsEditing(true)}>
                            Editar
                        </button>
                        <button className="btn btn-purple-400 btn-sm" onClick={handleDeleteSession}>
                            Eliminar
                        </button>
                    </div>
                )}
